	...
	public MultiClient(String id,String ip, int port) {
		...
		jframe.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				pw.println("exit");
				/*
				 * String readLine = null; try { readLine = br.readLine(); } catch (IOException
				 * e1) { // TODO Auto-generated catch block e1.printStackTrace(); } if(readLine
				 * != null && readLine.equals("exit")){ try { if(br != null) br.close(); if(pw
				 * != null) pw.close(); if(socket != null) socket.close();
				 * 
