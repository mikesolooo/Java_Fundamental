...
public class UnicastClient implements ActionListener{
	...
	public UnicastClient(String id, String ip, int port) {
		...
		jframe = new JFrame("babo Chatting");
		jp1 = new JPanel();
		jp2 = new JPanel();
		...
		jframe.add(jsp,BorderLayout.CENTER); // 채팅창
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == jtf) {
			...
			pw.println(id + " : " + message); // server에게 메시지 보냄
	...
	private void connect() {
		try {
			...
			pw = new PrintWriter(new BufferedWriter(new OutputStreamWriter(out)),true); //true: auto flush
